...
export function TokenBoard({ rows }: { rows: Row[] }) {
  ...
  return (
    <div className="border border-line bg-paper">
      <div className="grid grid-cols-[1fr_104px_84px_1fr_72px] gap-3 px-5 py-3 eyebrow border-b border-line">
        <div>Token</div>
      ...
      {rows.map((r) => {
        ...
        return (
          <div
            key={r.symbol}
            className="grid grid-cols-[1fr_104px_84px_1fr_72px] gap-3 px-5 py-3.5 text-sm items-center border-b border-line last:border-b-0 row-hover"
          >
            ...
            <div className="flex items-center gap-3 text-dim">
              <div className={tone}>
                <Sparkline values={r.spark} width={92} height={20} fill="currentColor" />
              </div>
